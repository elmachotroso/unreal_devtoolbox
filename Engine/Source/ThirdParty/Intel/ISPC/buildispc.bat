...
Set CMAKE_OPTIONS=%CMAKE_OPTIONS% -DGENX_ENABLED=OFF
...
Set CMAKE_OPTIONS=%CMAKE_OPTIONS% -DISPC_PS4_TARGET=OFF
Set CMAKE_OPTIONS=%CMAKE_OPTIONS% -DISPC_PS5_TARGET=OFF
