...
echo ANDROID_NDK_ROOT=%CurrentFolder%android-ndk-r14b>>"%OutputEnvVarsFolder%OutputEnvVars.txt"
echo NDK_ROOT=%CurrentFolder%android-ndk-r14b>>"%OutputEnvVarsFolder%OutputEnvVars.txt"
echo NDKROOT=%CurrentFolder%android-ndk-r14b>>"%OutputEnvVarsFolder%OutputEnvVars.txt"
