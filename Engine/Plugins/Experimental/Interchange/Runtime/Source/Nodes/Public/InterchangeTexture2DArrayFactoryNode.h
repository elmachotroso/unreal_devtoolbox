...
class INTERCHANGENODES_API UInterchangeTexture2DArrayFactoryNode : public UInterchangeTextureFactoryNode
{
	GENERATED_BODY()
...
#if WITH_EDITORONLY_DATA
	IMPLEMENT_NODE_ATTRIBUTE_APPLY_UOBJECT(AddressX, uint8, UTexture2DArray, TEnumAsByte<TextureAddress>);
	IMPLEMENT_NODE_ATTRIBUTE_APPLY_UOBJECT(AddressY, uint8, UTexture2DArray, TEnumAsByte<TextureAddress>);
	IMPLEMENT_NODE_ATTRIBUTE_APPLY_UOBJECT(AddressZ, uint8, UTexture2DArray, TEnumAsByte<TextureAddress>);
#endif
};